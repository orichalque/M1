...
///import classe_base.IncompatibleAirway;
/*
...
public class VolsCivil implements Flight {
	...
	private int nbPassager;
		...
		public VolsCivil(Airplane avion, Airport aeroportDep, Airport aeroportArr, FlightPlan planVol, int nbPassager) {
		this.avion = avion;
